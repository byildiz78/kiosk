          ...
          <div class="right">
            <div class="basket-info">
              <div class="basket-icon">
                ...
                <div class="basket-count" v-if="basket.count > 0">{{ basket.count }}</div>
              </div>
              <div class="details">
      ...
      >
        <div class="basket-area" v-if="basketIsOpen">
          ...
          <div class="basket-actions">
            <button class="cancel-btn ripple-btn" @click="orderCancelConfirmOpen">
          ...
          >
            <div class="basket-cancel" v-if="orderCancelConfirmIsOpen">
              <div class="cancel-content">
                ...
                <div class="actions">
                  <button class="cancel ripple-btn" @click="orderCancelConfirmCancel">
                    {{ $t('bottom.cancelOrderConfirm.no')}}
                  </button>
                  <button class="confirm ripple-btn" @click="orderCancelConfirmOk">
    ...
    <div class="bottom-nav">
      <div class="nav-content">
        ...
        <div class="impaired-selector">
          <button @click="impairedToggle" :class="{ active: impairedActive }" class="impaired-btn ripple-btn">
            <div class="btn-content">
